...
test:
	...
	node --experimental-strip-types --test apps/web/src/lib/telegramUser.test.ts apps/web/src/lib/apiBase.test.ts apps/web/src/lib/safeHref.test.ts apps/web/src/lib/cartPrices.test.ts
